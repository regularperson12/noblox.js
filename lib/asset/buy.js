...
const getSellers = require('./getPageResults.js').func
...
function runWithToken (args, resellerInfo) {
  console.log(args, resellerInfo)
  const jar = args.jar
...
exports.func = function (args, resellerInfo) {
  resellerInfo = getSellers(args.asset)
  if (!args.product) {
    return getProductInfo({
      ...
      .then(function (product) {
        ...
        return runWithToken(args, resellerInfo)
      })
  } else {
    return runWithToken(args, resellerInfo)
  }
